...
function validated(value) {
    if (value !="") {
        ...
        return "Answer the question Neo"
    }
}
...
function writeToFile(fileName, data) {
    fs.writeFile(fileName, markDownGen(data), function (error){
        if (error) {
...
function init() {
    inquirer.prompt(questions).then(data => {
        ...
        data.makeLicense = makeLicense(data.license);
